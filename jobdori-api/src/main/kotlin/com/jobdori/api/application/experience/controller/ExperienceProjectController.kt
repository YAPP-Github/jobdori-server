...
class ExperienceProjectController(
    ...
    @PostMapping("/v1/workspaces/{workspaceId}/experience-projects")
    @Authenticated
    ...
    @PatchMapping("/v1/workspaces/{workspaceId}/experience-projects/{projectId}")
    @Authenticated
    ...
    @DeleteMapping("/v1/workspaces/{workspaceId}/experience-projects/{projectId}")
    @Authenticated
