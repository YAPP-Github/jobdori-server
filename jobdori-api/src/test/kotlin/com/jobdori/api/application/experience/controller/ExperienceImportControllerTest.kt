...
internal class ExperienceImportControllerTest(
    ...
    "PDF 파일에서 경험을 가져온다" {
        ...
        every { experienceImportService.importExperiencesByPdf(file = any(), userId = 1L) } returns Unit

        mockMvc.multipart("/v1/experiences/imports/pdf") {
        ...
        verify(exactly = 1) { experienceImportService.importExperiencesByPdf(file = file, userId = 1L) }
    }
